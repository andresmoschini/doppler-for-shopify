...
describe('The doppler-client module', function () {
  ...
  it('AreCredentialsValidAsync should return true when valid credentials are provided', async function () {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com?api_key=C22CADA13759DB9BBDF93B9D87C14D5A');
  });
  ...
  it('getListsAsync should return the array of lists', async function () {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com/lists?page=1&per_page=200&state=active&api_key=C22CADA13759DB9BBDF93B9D87C14D5A');
  });
  ...
  it('getImportTaskAsync should return the import details', async function () {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com/tasks/import-222031?api_key=C22CADA13759DB9BBDF93B9D87C14D5A');
  });
  ...
  it('createListAsync should create the list', async function () {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com/lists?api_key=C22CADA13759DB9BBDF93B9D87C14D5A',
        { body: '{"name":"Fresh List"}', method: "POST" });
  });
  ...
  it('getFieldsAsync should return the array of fields', async function () {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com/fields?api_key=C22CADA13759DB9BBDF93B9D87C14D5A');
  });
  ...
  it("importSubscribersAsync should import the subscribers with the mapped fields", async function() {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com/lists/178945/subscribers/import?api_key=C22CADA13759DB9BBDF93B9D87C14D5A',
        { body: expectedRequestBody, method: 'POST' });
  });
  ...
  it("createSubscriberAsync should create the subscriber with the mapped fields", async function() {
    ...
    expect(spyRequest).to.be.calledWithExactly('https://restapi.fromdoppler.com/accounts/user%40example.com/lists/178945/subscribers?api_key=C22CADA13759DB9BBDF93B9D87C14D5A',
        { body: expectedRequestBody, method: 'POST' });
  });
});